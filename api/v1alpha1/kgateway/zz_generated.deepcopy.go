...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GrpcStats) DeepCopyInto(out *GrpcStats) {
	*out = *in
	if in.StatsForAllMethods != nil {
		in, out := &in.StatsForAllMethods, &out.StatsForAllMethods
		*out = new(bool)
		**out = **in
	}
	if in.MethodAllowlist != nil {
		in, out := &in.MethodAllowlist, &out.MethodAllowlist
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.EnableUpstreamStats != nil {
		in, out := &in.EnableUpstreamStats, &out.EnableUpstreamStats
		*out = new(bool)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GrpcStats.
func (in *GrpcStats) DeepCopy() *GrpcStats {
	if in == nil {
		return nil
	}
	out := new(GrpcStats)
...
func (in *HTTPSettings) DeepCopyInto(out *HTTPSettings) {
	*out = *in
	...
	if in.GrpcStats != nil {
		in, out := &in.GrpcStats, &out.GrpcStats
		*out = new(GrpcStats)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *JWTCache) DeepCopyInto(out *JWTCache) {
	*out = *in
	if in.Size != nil {
	...
	if in.MaxTokenSize != nil {
		in, out := &in.MaxTokenSize, &out.MaxTokenSize
		*out = new(uint32)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new JWTCache.
func (in *JWTCache) DeepCopy() *JWTCache {
	if in == nil {
		return nil
	}
	out := new(JWTCache)
